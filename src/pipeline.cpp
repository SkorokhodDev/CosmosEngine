...
namespace Cosmos {
    ...
    Pipeline::Pipeline(EngineDevice& device, const std::string& vertFilePath, const std::string& fragFilePath,
    ...
    {        
        ...
        // configures pipeline to expect a dynamic viewport and dynamic scissor
        ...
        configInfo.bindindDescriptions = Model::Vertex::getBindingDescriptions();
        ...
        const PipelineConfigInfo& configInfo) 
    {
        ...
        auto& bindingDescriptions = configInfo.bindindDescriptions;
